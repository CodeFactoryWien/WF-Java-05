...
public class Controller {
    ...
    TableColumn<String, String> shoppingcartCol = new TableColumn<String, String>("Shoppingcart");
    ...
    public void initialize() throws SQLException {
        ...
        con = DriverManager.getConnection("jdbc:mysql://localhost:3306/feelgoodltd?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=Europe/Berlin", "root","");
        createCoffeeTable();
        createTeaTable();
    ...
    public void createCoffeeTable() throws SQLException {
        ...
        ResultSet rs = stmt.executeQuery("SELECT productID,productname,singleprice,bulkprice,instock FROM product WHERE category LIKE ('Coffee') AND instock <> 0");
    ...
    public void createTeaTable() throws SQLException {
        ...
        ResultSet rs2 = stmt2.executeQuery("SELECT productID,productname,singleprice,bulkprice,instock FROM product WHERE category LIKE ('Tea') AND instock <> 0");
    ...
    public void createSoftDrinksTable() throws SQLException {
        ...
        ResultSet rs3 = stmt3.executeQuery("SELECT productID,productname,singleprice,bulkprice,instock FROM product WHERE category LIKE ('Soft Drinks') AND instock <> 0");
    ...
    public void createEnergyDrinksTable() throws SQLException {
        ...
        ResultSet rs4 = stmt4.executeQuery("SELECT productID,productname,singleprice,bulkprice,instock FROM product WHERE category LIKE ('Energy Drinks') AND instock <> 0");
    ...
    public void addtoshoppingcart(){
        ...
        shoppingcartList.add("No. "+productID.getText()+" productname: "+productnameText.getText()+" "+"amount: "+amountText.getText()+" total: "+total+"€");
    ...
    public void selectitemshoppingcart() throws SQLException {
        ...
        ResultSet rs = stmt.executeQuery("SELECT singleprice,bulkprice FROM product WHERE productID = "+buffID);
        while (rs.next()){
    ...
    public void userlogin() throws SQLException {
        Statement stmt = con.createStatement();
        ResultSet rs = stmt.executeQuery("SELECT orderID,status,total,date FROM ordertab WHERE clientID = "+clientID.getText());
        for (int i = 0; i < rs.getMetaData().getColumnCount(); i++) {
            // We are using non property style for making dynamic table
            final int j = i;
            TableColumn col = new TableColumn(rs.getMetaData().getColumnName(i + 1));
